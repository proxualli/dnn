...
namespace dnn
{
	...
	public:
		...
		Activation(const dnn::Device& device, const dnnl::memory::format_tag format, const std::string& name, const Activations activation, dnn::Inputs inputs, const Float alpha = Float(0), const Float beta = Float(0)) :
