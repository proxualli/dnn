...
namespace
{
	...
	auto GetThreads(const UInt elements, const Float weight = Float(1)) NOEXCEPT
	{
		...
		const auto LIGHT      = MAX_THREADS >= 32ull ?  4ull : MAX_THREADS >= 24ull ?  4ull : MAX_THREADS >= 16ull ?  4ull : MAX_THREADS >= 12ull ? 3ull : 2ull;
		const auto MEDIUM     = MAX_THREADS >= 32ull ?  8ull : MAX_THREADS >= 24ull ?  8ull : MAX_THREADS >= 16ull ?  8ull : MAX_THREADS >= 12ull ?  6ull : MAX_THREADS >= 8ull ? 4ull : MAX_THREADS >= 6ull ? 3ull : 2ull;
