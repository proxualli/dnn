...
namespace dnn
{
	...
	public:
		...
		Resampling(const dnn::Device& device, const dnnl::memory::format_tag format, const std::string& name, const std::vector<std::shared_ptr<Layer>>& inputs, const Algorithms algorithm, const Float factorH, const Float factorW) :
