...
namespace dnn
{
	...
	public:
		...
		ChannelSplit(const dnn::Device& device, const dnnl::memory::format_tag format, const std::string& name, dnn::Inputs inputs, const size_t group, const size_t groups) :
