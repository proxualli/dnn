...
#endif
{
    ...
    if (DNNReadDefinition(model, msg) == 1)
    {
        if (DNNLoadDataset())
        {
            ...
            DNNAddLearningRateSGDR(true, 1, *trainingSamples, Optimizers::AdamW, 0.9f, 0.999f, 0.055f, 0.000001f, 128, 1, 200, 1, 0.001f, 0.0001f, 1.0f, 1, true, false, 0.0f, 0.7f, 0.7f, 0.7f, 20, 0.7f, Interpolations::Cubic, 10.0f, 12.0f);
            DNNTraining();
