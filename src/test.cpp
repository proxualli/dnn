...
DNN_API int DNNLoadDefinition(std::string fileName, const Optimizers optimizer, CheckMsg& checkMsg);
DNN_API int DNNReadDefinition(std::string definition, const Optimizers optimizer, CheckMsg& checkMsg);
DNN_API void DNNDataprovider(std::string directory);
DNN_API int DNNLoadNetworkWeights(std::string fileName, const bool persistOptimizer);
DNN_API int DNNSaveNetworkWeights(std::string fileName, const bool persistOptimizer);
DNN_API int DNNLoadLayerWeights(std::string fileName, const size_t layerIndex, const bool persistOptimizer);
DNN_API int DNNSaveLayerWeights(std::string fileName, const size_t layerIndex, const bool persistOptimizer);
