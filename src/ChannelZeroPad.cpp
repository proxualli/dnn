...
namespace dnn
{
	...
	std::string ChannelZeroPad::GetDescription() const
	{
		return GetDescriptionHeader();
	}

	size_t ChannelZeroPad::FanIn() const
	{
		return 1;
	}

	size_t ChannelZeroPad::FanOut() const
	{
		return 1;
	}

	void ChannelZeroPad::InitializeDescriptors(const size_t batchSize)
	{
	...
	void ChannelZeroPad::ForwardProp(const size_t batchSize, const bool training)
	{
	...
	void ChannelZeroPad::BackwardProp(const size_t batchSize)
	{
#ifdef DNN_LEAN
